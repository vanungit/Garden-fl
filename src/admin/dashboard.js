...
class Dashboard extends Component {
    ...
    render() {
        ...
        const listOrders = listOrdersRequest.map((item, index) => {
            return <ItemDashBoard key={index} {...item} />
        });

        const listUsers = this.props.stateReducers.dataUsers.reverse().map((item, index) => {
            return <div className="mutiList_item" key={index}>
                <div className="mutiList_item-avatar">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24">
                        <path d="M20.822 18.096c-3.439-.794-6.64-1.49-5.09-4.418 4.72-8.912 1.251-13.678-3.732-13.678-5.082 0-8.464 4.949-3.732 13.678 1.597 2.945-1.725 3.641-5.09 4.418-3.073.71-3.188 2.236-3.178 4.904l.004 1h23.99l.004-.969c.012-2.688-.092-4.222-3.176-4.935z" />
                    </svg>
                </div>
                <div className="mutiList_item-text">
                    {item.name}
                </div>
            </div>
        });
                ...
                <div>
                    <div className="dashboard_title">
                        ...
                        <div className="newCustomers">
                            ...
                            <div className="dashboard_title-text">
                                <p>New Customers</p>
                                <p>{this.props.stateReducers.dataUsers.length}</p>
                            </div>
                            <div className="mutiList">
                                {listUsers}
                            </div>
